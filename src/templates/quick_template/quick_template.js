...
export class QuickTemplate{
    ...
    getDefaultCssList(){
        return [
            CDN + `src/templates/quick_template/dist/quick_template.css`
        ]
    }
    ...
    getDefaultTranslations(){
        return [
            CDN + `src/templates/quick_template/translations/${LANGUAGE_TOKEN}.json`
        ]
    }
        ...
        return `
                <div class="${ID}-view-group-head line" ${PREFIX}group="${group.id}" ${PREFIX}status="${group.status}">
                    ...
                    <div class="line-content">
                        <div class="${ID}-view-group-name title" ${PREFIX}group-toggle="${group.id}">${this.html(group.name)}${this.getMandatoryText(group)}</div>
                        <div class="${ID}-view-group-description description sec">${this.html(group.description)}</div>
                    </div>
                </div>
    ...
    getServiceMarkup(service){
        ...
        return `
            <div class="${ID}-view-service line"  ${PREFIX}service="${service.id}" ${PREFIX}status="${service.status}">
                ...
                <div class="line-content">
                    <div class="${ID}-view-service-name title" ${PREFIX}service-toggle="${service.id}">${this.html(service.name)}${this.getMandatoryText(service)}</div>
                    <div class="${ID}-view-service-description description sec">${this.html(service.description)}</div>
                    ${doc}
                </div>
            </div>
        `
...
window[ID]['template_class']['QuickTemplate'] = QuickTemplate;
