import { ID, PREFIX, CDN, LANGUAGE_TOKEN } from "bim-gdpr/src/core/tools/Tools";

/**
 * Class for the column_choice template.
 */
export class ColumnChoiceTemplate{

    constructor(){
        this.id = 'column_choice'
     ...
     *  'CDN + `src/templates/column_choice/translations/fr-FR.json`'
     * 
     * @returns {Array}.
     */
        ...
        const content = `
            <div class="${ID}-view-main">
                <div class="${ID}-view-head"> 
                    ...
                    <div>${this.html(`This site uses some services that enhance your user experience and add external content. Some of them can require and use personal data. You can manage their activation through this pannel at any moment. You can also manage them by clicking on <strong @attributes>Detail</strong>.`, {'@attributes': `${PREFIX}view-toggle-detail`})}</div>
                </div>

                <div class="${ID}-view-quick">
                    <div class="${ID}-view-quick-disable-wrapper">
                        <button ${PREFIX}all-disable="deny_all">${this.html('Enable only essential services')}</button>
                    </div>
                    <div class="${ID}-view-quick-enable-wrapper">
                        <button ${PREFIX}all-enable="accept_all">
                            ...
                            ${this.html('Enable all personal services')}
                        </button>
                    </div>
                </div>
            </div>
            <div class="${ID}-view-detail">
                ${markup}
                <button class="${ID}-view-detail-save" ${PREFIX}view-hide>${this.html('OK')}</button>
            </div>`
...
window[ID]['template_class']['ColumnChoiceTemplate'] = ColumnChoiceTemplate;
